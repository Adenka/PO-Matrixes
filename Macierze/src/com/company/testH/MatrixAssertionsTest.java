...
public class MatrixAssertionsTest {
    ...
    void testInvalidConstructorsThrowsOnNull() {
        ...
        assertThrows(AssertionError.class, () -> consty(-1, null));
        assertThrows(AssertionError.class, () -> rowy(null, 3));
        assertThrows(AssertionError.class, () -> columny(null, -3));
    }
