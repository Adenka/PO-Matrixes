...
import com.company.DoubleMatrixFactory;
import com.company.IDoubleMatrix;

import static org.junit.jupiter.api.Assertions.assertArrayEquals;
import static org.junit.jupiter.api.Assertions.assertEquals;
import static com.company.DoubleMatrixFactory.consty;
import static com.company.DoubleMatrixFactory.zero;
...
public class MatrixBinaryOperationTest {
    ...
    void testConstantMatricesAddition() {
        final var l = consty(10, matrix(1000000, 1000000));
        final var r = consty(25, matrix(1000000, 1000000));
        final var resultAdd = l.plus(r);
        final var resultSubtract = l.minus(r);
